...
RSpec.describe 'Search Index' do
  ...
  it 'should show piece information' do
    ...
    data_response = stub_request(:get, 'http://127.0.0.1:9393/api/v1/search?q=violin').to_return(status: 200, body: File.read('spec/data/search_data.json'))
  ...
  it 'should render something different if page had no results' do
    stub_request(:get, 'http://127.0.0.1:9393/api/v1/search?q=qwerrewer').to_return(status: 200, body: File.read('spec/data/search_not_found.json'))
